...
WYMeditor.editor.prototype.paste = function(sData) {
  ...
  var aP = sData[0].split(this._newLine + this._newLine);
...
WYMeditor.XhtmlSaxListener = function()
{
  ...
  this.entities = {
    ...
    this.block_tags = ["a", "abbr", "acronym", "address", "area", "audio", "b",
    ...
    "thead", "title", "tr", "tt", "ul", "var", "video", "extends"];


    this.inline_tags = ["br", "hr", "img", "input", "embed", "param", "source"];
