...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('slideshows_slideshow', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='slideshows_slideshow_created', null=True, to=orm['auth.User'])),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='slideshows_slideshow_modified', null=True, to=orm['auth.User'])),
        ))
    ...
    models = {
        ...
        'slideshows.slideshow': {
            'Meta': {'ordering': "('-date_modified',)", 'object_name': 'Slideshow'},
            'caption': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'slideshows_slideshow_created'", 'null': 'True', 'to': "orm['auth.User']"}),
